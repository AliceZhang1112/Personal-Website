...
const projects = [{
        ...
        description: "A  app built using basic react.",
        tagimg: "https://cdn.iconscout.com/icon/free/png-512/react-1-282599.png",
        Previewlink: "Personal-Website/MobileApp.html",
        Githublink: "",
    },
    {
        title: "Chess Engine",
        ...
        Previewlink: "Personal-Website/chess.html",
        Githublink: "",
    },
    {
        title: "Flappy Bird",
...
const showCards = () => {
    ...
    projects.forEach(({ title, cardImage, description, Previewlink, Githublink }) => {
        output += ` 
        <div onclick="bruh('${Previewlink}')" class="column skill-card card" style="margin: 15px"data-aos="zoom-in-up" data-aos-easing="linear" data-aos-delay="300" data-aos-duration="600" >
